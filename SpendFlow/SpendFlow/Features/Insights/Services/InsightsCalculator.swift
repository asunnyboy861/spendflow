...
class InsightsCalculator {
    ...
    func calculateCategorySpending(_ transactions: [Transaction]) -> [CategorySpending] {
    ...
    func calculateMonthlyTrend(_ transactions: [Transaction]) -> [MonthlyData] {
    ...
    func calculateBudgetComparison(_ transactions: [Transaction], _ budgets: [Budget]) -> [BudgetComparison] {
